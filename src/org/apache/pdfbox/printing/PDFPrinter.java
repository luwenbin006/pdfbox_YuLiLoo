...
public class PDFPrinter
{
    ...
    protected Paper paper; // may be null
    ...
    protected class PDFPageable implements Pageable
    {
        ...
        public PageFormat getPageFormat(int pageIndex)
        {
            ...
            //According to page filled the print range [modify by webster lu]
            paper = new Paper();
            paper.setImageableArea(page.getMediaBox().getLowerLeftX(), page.getMediaBox().getLowerLeftY(), page.getMediaBox().getWidth(), page.getMediaBox().getHeight());            
